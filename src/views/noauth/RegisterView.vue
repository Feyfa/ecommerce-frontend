        ...
        <div class="w-full max-w-[26rem] space-y-4 relative z-[1]">
            <section v-if="!isClerkEnabled" class="auth-card">
                <div class="text-center">
                    ...
                    <p class="auth-subtitle">Konfigurasi register belum lengkap. Silakan hubungi admin aplikasi.</p>
                </div>
            </section>
                ...
                >
                    <template v-if="isClerkVerificationStep">
                        <div class="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700">
                            Kode verifikasi email sudah dikirim. Silakan cek inbox email Anda lalu masukkan kodenya di
                            bawah ini.
                        </div>
                        ...
                        <div class="auth-field">
                            ...
                            <small v-if="errors.verificationCode" class="auth-error-text">{{
...
export default {
    ...
    /**
     * Menginisialisasi state Composition API dan integrasi komponen pada halaman registrasi.
     *
    ...
    /**
     * Membuat state reaktif yang digunakan komponen untuk halaman register.
     *
    ...
    computed: {
        /**
         * Menentukan apakah kondisi clerk enabled terpenuhi untuk halaman register.
         *
        ...
        /**
         * Menentukan apakah kondisi clerk signed in terpenuhi untuk halaman register.
         *
        ...
        /**
         * Menentukan apakah kondisi clerk resolving terpenuhi untuk halaman register.
         *
        ...
        /**
         * Menentukan apakah kondisi clerk verification step terpenuhi untuk halaman register.
         *
        ...
        /**
         * Mengembalikan register button label yang dihitung dari state reaktif saat ini untuk halaman register.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi register button label.
         */
        registerButtonLabel() {
        ...
        /**
         * Menentukan apakah kondisi show bridge panel terpenuhi untuk halaman register.
         *
    ...
    watch: {
        isClerkSignedIn: {
            ...
            /**
             * Menyinkronkan state komponen ketika is clerk signed in berubah untuk halaman register.
             *
    ...
    /**
     * Menginisialisasi behavior komponen yang bergantung pada browser setelah mounted untuk halaman register.
     *
     * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
     */
    mounted() {
    ...
    methods: {
        /**
         * Menjalankan proses notify auth callback error dan menyinkronkan state hasilnya untuk halaman register, termasuk state navigasi yang dihasilkan.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        ...
        /* VALIDATION INPUT */
        /**
         * Memvalidasi and synchronize input name untuk halaman register.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        watchInputName() {
        ...
        /**
         * Memvalidasi and synchronize input email untuk halaman register.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        watchInputEmail() {
        ...
        /**
         * Memvalidasi and synchronize inpu password untuk halaman register.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        watchInpuPassword() {
        ...
        /**
         * Memvalidasi and synchronize input verification code untuk halaman register.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        ...
        /**
         * Mengembalikan clerk verification step ke state awal untuk halaman register.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        ...
        async bridgeClerkSessionToBackend({ requireSignedIn = true } = {}) {
            ...
            try {
                ...
                this.clerkBootstrapErrorMessage =
                    'Akun sudah aktif, tetapi aplikasi belum berhasil menyiapkan data Anda. Coba lagi sebentar.';
            } finally {
        ...
        /**
         * Menjalankan proses logout clerk session dan menyinkronkan state hasilnya untuk halaman register, termasuk state navigasi yang dihasilkan.
         *
         * @returns {Promise<void>} Promise diselesaikan setelah alur asynchronous selesai.
         */
        ...
        async signUpWithGoogle() {
            // --- step 1 - start - pastikan resource autentikasi siap sebelum memulai register Google
            ...
            // --- step 1 - end - pastikan resource autentikasi siap sebelum memulai register Google

            this.isProcessingGoogleRegister = true;

            try {
                // --- step 2 - start - siapkan sesi browser bersih dan tentukan resource sign-in aktif
                await prepareBrowserForNewAuthentication(this.$store);
                await this.$nextTick();

                const runtimeState = getClerkRuntimeState();
                const signInResource =
                    runtimeState.clerk?.client?.signIn ||
                ...
                // --- step 2 - end - siapkan sesi browser bersih dan tentukan resource sign-in aktif

                // --- step 3 - start - simpan konteks callback dan redirect melalui autentikasi Google
                ...
                // --- step 3 - end - simpan konteks callback dan redirect melalui autentikasi Google
            } catch (error) {
                ElNotification({
                    type: 'error',
                    title: 'error',
        ...
        /**
         * Mengembalikan register submit yang ditentukan modul untuk halaman register.
         *
         * @returns {Promise<void>} Promise diselesaikan setelah alur asynchronous selesai.
         */
        ...
        async createClerkAccount() {
            ...
            if (this.name.trim() === '' || this.email.trim() === '' || this.password.trim() === '') {
                if (this.name.trim() === '') this.errors.name = 'input name is required';
        ...
        /**
         * Mengembalikan resend clerk verification code yang ditentukan modul untuk halaman register.
         *
         * @returns {Promise<void>} Promise diselesaikan setelah alur asynchronous selesai.
         */
