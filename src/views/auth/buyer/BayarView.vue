    ...
    <div v-if="show.bayar_view" class="min-h-full w-full bg-slate-50 px-4 pb-8 pt-4 lg:px-6">
        <div class="mb-5">
            ...
            <p class="mt-2 text-sm text-slate-500">
                Gunakan halaman ini untuk simulasi pembayaran virtual account di local development.
            </p>
        </div>
        ...
        <div class="w-full rounded-md border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-100 px-4 py-4 sm:px-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Pilih bank dan masukkan nomor virtual account yang ingin disimulasikan.
                </p>
            </div>
            ...
            <div class="flex flex-col gap-4 px-4 py-5 sm:px-5">
                ...
                >
                    <label for="paymentName" class="mb-1.5 font-medium text-slate-700">
                        Nama Bank
                    ...
                    <small v-if="errors.paymentName" class="mt-1 text-sm text-red-500">
                        {{ errors.paymentName }}
                    </small>
                </div>
                <div
                ...
                >
                    ...
                    <small v-if="errors.paymentVirtualAccount" class="mt-1 text-sm text-red-500">
...
export default {
    /**
     * Membuat state reaktif yang digunakan komponen untuk halaman bayar.
     *
    ...
    /**
     * Menginisialisasi behavior komponen yang bergantung pada browser setelah mounted untuk halaman bayar.
     *
    ...
    methods: {
        /**
         * Membersihkan form simulate virtual account untuk halaman bayar.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        ...
        /**
         * Mengambil payment list untuk halaman bayar, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        getPaymentList() {
        ...
        /**
         * Menjalankan proses payment name perubahan dan menyinkronkan state hasilnya untuk halaman bayar.
         *
        ...
        /**
         * Menjalankan proses payment virtual account perubahan dan menyinkronkan state hasilnya untuk halaman bayar.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        ...
        /**
         * Menjalankan proses payment name blur dan menyinkronkan state hasilnya untuk halaman bayar.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        paymentNameBlur() {
        ...
        /**
         * Menjalankan proses payment virtual account blur dan menyinkronkan state hasilnya untuk halaman bayar.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        ...
        /**
         * Menjalankan proses simulate charge virtual account dan menyinkronkan state hasilnya untuk halaman bayar, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
            ...
            this.$store
                ...
                .then((response) => {
                    ...
                    ElNotification({
                        type: 'success',
                        title: 'Success',
                        message: `Nomor Virtual ${paymentVirtualAccount} Berhasil Dibayar`,
                    });
                })
                .catch((error) => {
                    console.error(error);
