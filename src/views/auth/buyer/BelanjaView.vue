<template>
    ...
    >
        ...
        >
            ...
            <div
                class="mt-3 grid grid-cols-1 gap-3 lg:grid-cols-[minmax(14rem,27rem)_1fr_14rem_10.5rem] lg:items-end"
            >
            ...
            <div
                v-if="activeBelanjaFilterChips.length > 0"
                ...
                >
                    ...
                    <div class="flex flex-1 flex-col justify-between p-3">
                        <div class="flex flex-col">
                            <span
                                class="mb-1 truncate text-[.72rem] font-medium leading-4 text-slate-500"
                                >{{ product.u_name }}</span
                            >
                            <h4
                                class="mt-0.5 truncate text-sm font-medium leading-5 text-slate-900"
                            >
                                {{ product.p_name }}
                            </h4>
                            <h4
                                class="mt-1 text-sm font-semibold leading-5 text-slate-950"
                            >
                        ...
                        >
                            ...
                            <button
                                ...
                                @click="
                                    addKeranjang(product.p_id, product.u_id)
                                "
                            >
                                <svg
                                    class="w-4"
...
export default {
    ...
    computed: {
        ...
        /**
         * Membuat chip filter aktif agar buyer mudah melihat kondisi daftar produk.
         */
    ...
    methods: {
        ...
        /**
         * Menghapus semua filter belanja dan mengembalikan urutan default.
         */
        resetBelanjaFilters() {
                    ...
                    if (error.response?.status == 409) {
                        ElNotification({
                            ...
                            message:
                                ...
                                "Produk sementara tidak dapat ditambahkan ke keranjang.",
                        });
