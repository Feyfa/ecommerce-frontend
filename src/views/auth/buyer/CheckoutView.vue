<template>
    <!-- Checkout View -->
    <div
        v-if="show.checkout_view"
        class="min-h-full w-full bg-slate-50 px-3 pb-28 pt-4 text-slate-950 sm:px-5 lg:px-6 lg:pb-6"
    >
        <div class="checkout-container w-full">
            <div class="mb-4 flex flex-col gap-1">
                <h1 class="text-3xl font-medium text-slate-950">Checkout</h1>
                <p class="text-sm font-medium text-slate-500">
                    Review pesanan, pengiriman, dan pembayaran sebelum lanjut.
                </p>
            </div>
            ...
            <div class="flex flex-col items-start gap-5 lg:flex-row">
                            ...
                            <div class="flex flex-col gap-3 border-t border-slate-100 bg-slate-50/70 px-4 py-4 text-sm">
                                <div class="grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        >
                                        <div
                                            class="flex h-11 items-center rounded-md border border-slate-200 bg-white px-3 text-sm font-medium text-slate-700"
                                        >
                ...
                <!-- CHECKOUT -->
                <div
                    class="w-full rounded-md border border-slate-200 bg-white shadow-sm lg:sticky lg:top-6 lg:w-[35%] xl:w-[30%]"
                >
                    <!-- list payment -->
                    <div class="w-full px-4 py-4">
                        ...
                        <div class="mt-3 flex flex-col overflow-hidden rounded-md border border-slate-200">
                            <div
                                ...
                                :class="{
                                    'bg-violet-50': paymentName == item.name,
                                }"
        ...
        setEnableAlamatBuyer(id, index) {
            ...
            this.$store
                ...
                .then((response) => {
                    ...
                    this.activeAlamat = response.currentAlamat;
        ...
        getDataCheckout() {
            ...
            this.$store
                ...
                .then((response) => {
                    ...
                    /* DATA */
                    this.activeAlamat = response.alamat;
