                ...
                <div class="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    >
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <span
                                class="flex h-12 w-12 shrink-0 items-center justify-center rounded-md border border-violet-100 bg-violet-50 text-violet-600"
                            >
                    ...
                    <div class="min-h-64 rounded-md border border-slate-100 bg-slate-50 p-4">
                        <div v-if="hasPerformanceData" class="h-64 w-full">
                            <svg
                                ...
                                class="h-full w-full"
                                role="img"
                                aria-label="Grafik pendapatan penjualan 30 hari terakhir"
                            >
                        ...
                        <div v-else class="flex h-64 flex-col items-center justify-center text-center">
                            <span
                                class="flex h-12 w-12 items-center justify-center rounded-full bg-violet-50 text-violet-600"
                            >
                    ...
                    <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
                        ...
                        <div class="rounded-md border border-slate-100 bg-slate-50 p-4">
                            ...
                            <h3 class="mt-2 text-2xl font-semibold text-slate-950">
                                {{ formatRupiah(performance.total_revenue) }}
                            </h3>
                        </div>
                    </div>
                </div>
...
export default {
    /**
     * Membuat state reaktif yang digunakan komponen untuk halaman dashboard.
     *
    ...
    computed: {
        /**
         * Memproses summary cards untuk halaman dashboard.
         *
         * @returns {Array<*>} Kumpulan summary cards yang telah disiapkan.
         */
        summaryCards() {
            return [
                {
                    label: 'Total Produk',
                    value: this.formatNumber(this.summary.total_products),
                    icon: 'fa-solid fa-box',
                },
                {
                    label: 'Pesanan Baru',
                    value: this.formatNumber(this.summary.new_orders),
                    icon: 'fa-solid fa-receipt',
                },
                {
                    label: 'Total Terjual',
                    value: this.formatNumber(this.summary.total_sold),
                    icon: 'fa-solid fa-bag-shopping',
                },
                {
                    label: 'Pendapatan Bulan Ini',
                    value: this.formatRupiah(this.summary.monthly_revenue),
        ...
        /**
         * Memproses produk snapshot items untuk halaman dashboard.
         *
         * @returns {Array<*>} Kumpulan produk snapshot items yang telah disiapkan.
         */
        ...
        /**
         * Memproses quick actions untuk halaman dashboard.
         *
         * @returns {Array<*>} Kumpulan quick actions yang telah disiapkan.
         */
        quickActions() {
            return [
        ...
        /**
         * Menentukan apakah kondisi performance data terpenuhi untuk halaman dashboard.
         *
         * @returns {boolean} Menunjukkan apakah kondisi has performance data terpenuhi.
         */
        hasPerformanceData() {
        ...
        /**
         * Mengembalikan chart point list yang dihitung dari state reaktif saat ini untuk halaman dashboard.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi chart point list.
         */
        chartPointList() {
        ...
        /**
         * Mengembalikan chart points yang dihitung dari state reaktif saat ini untuk halaman dashboard.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi chart points.
         */
        chartPoints() {
    ...
    /**
     * Menginisialisasi behavior komponen yang bergantung pada browser setelah mounted untuk halaman dashboard.
     *
    ...
    methods: {
        /**
         * Mengambil dashboard untuk halaman dashboard, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        getDashboard() {
        ...
        /**
         * Memformat number untuk ditampilkan untuk halaman dashboard.
         *
         * @param {*} value Nilai yang diproses oleh function.
         *
         * @returns {string} Teks format number yang telah diformat atau ditentukan.
         */
        formatNumber(value) {
        ...
        /**
         * Memformat rupiah untuk ditampilkan untuk halaman dashboard.
         *
         * @param {*} value Nilai yang diproses oleh function.
         *
        ...
        /**
         * Memproses status label untuk halaman dashboard.
         *
         * @param {*} transaction Transaksi yang diproses oleh function.
         *
         * @returns {string} Teks status label yang telah diformat atau ditentukan.
         */
        statusLabel(transaction) {
            if (transaction.invoice_status == 'pending') return 'Belum Dibayar';

            if (transaction.status == 'approved_seller') return 'Perlu Diproses';

            if (transaction.status == 'done') return 'Selesai';

            return 'Transaksi';
        },

        /**
         * Memproses class status untuk halaman dashboard.
         *
         * @param {*} transaction Transaksi yang diproses oleh function.
         *
        ...
        statusClass(transaction) {
            if (transaction.invoice_status == 'pending') return 'bg-amber-50 text-amber-700';

            if (transaction.status == 'approved_seller') return 'bg-violet-50 text-violet-700';

            if (transaction.status == 'done') return 'bg-emerald-50 text-emerald-700';
