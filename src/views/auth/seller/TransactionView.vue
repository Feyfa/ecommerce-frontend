<template>
    ...
    <div v-show="!show.loading" class="w-full">
        ...
        <div class="flex w-full flex-col items-center p-4 lg:px-6">
            <div
                v-if="counts.all == 0 && selectedFilter == 'all' && !searchKeyword.trim()"
...
export default {
    ...
    methods: {
        ...
        /**
         * Menjalankan proses approved transaksi dan menyinkronkan state hasilnya untuk halaman transaksi, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
         *
         * @param {*} transaction_user_id Nilai transaksi user id yang diproses oleh function.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        approvedTransaction(transaction_user_id) {
            ElMessageBox.confirm('Yakin Ingin Menyetujui Transaksi Ini ?', 'Persetujuan', {
                ...
                /**
                 * Menjalankan proses callback dan menyinkronkan state hasilnya untuk halaman transaksi, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
                 *
                 * @param {*} action Nilai action yang diproses oleh function.
                 *
                 * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
                 */
                callback: (action) => {
                        ...
                        this.$store
                            ...
                            .then((response) => {
                                ...
                                ElNotification({
                                    type: 'success',
                                    title: 'Success',
                                    message: 'Persetujuan Transaksi Berhasil, Uang Sudah Masuk Ke Saldo Anda',
                                });
                            })
                            .catch((error) => {
                                console.error(error);
