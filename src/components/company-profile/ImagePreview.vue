<template>
    <div class="relative">
        ...
        <div role="status" class="absolute top-0 bottom-0 left-0 right-0 flex justify-center items-center bg-[rgba(0,0,0,.5)] rounded" v-if="isProcessImageCompany">
        ...
        <div 
            class="h-32 w-32 bg-cover bg-no-repeat bg-center border border-neutral-500 rounded shadow-md cursor-pointer" :style="{ backgroundImage: `url(${src})` }"
            @click="togglePreview"
            @click.stop>
        </div>
        ...
        <ul 
            ...
            :class="this.$global.isClickDropdown.company ? 'border border-neutral-500 h-[6.25rem] shadow-lg p-2' : 'h-0'">
            <li>
                <span 
