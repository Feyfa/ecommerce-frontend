        ...
        <div class="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
            <div v-if="showPaymentCard" class="grid min-w-0 gap-3 sm:grid-cols-3">
                <div class="flex min-w-0 items-center gap-3 rounded-md bg-neutral-50 p-3">
                    ...
                    <span
                        v-else
                        class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-white text-violet-700"
                    >
            ...
            <div v-else class="flex min-w-0 gap-3">
                ...
                ></div>
                <div class="min-w-0">
                    <h3 class="truncate text-sm font-semibold text-neutral-900 sm:text-base">
                        {{ primaryProduct?.name ?? '-' }}
                    </h3>
                    <p class="mt-1 text-sm text-neutral-600">
                        {{ primaryProduct?.total ?? 0 }} x {{ formatCurrency(primaryProduct?.price) }}
                    </p>
                    <p v-if="hiddenProductsCount > 0" class="mt-2 text-xs font-semibold text-violet-700">
                        +{{ hiddenProductsCount }} produk lainnya
                    </p>
            ...
            <div class="flex flex-col gap-3 lg:items-end">
                <div class="flex w-full flex-col gap-3 sm:w-[230px]">
                    ...
                    <div class="grid gap-2" :class="showPaymentButton ? 'grid-cols-2' : 'grid-cols-1'">
                        <button
                            class="inline-flex min-w-0 items-center justify-center rounded-md border border-violet-600 px-3 py-2 text-sm font-semibold text-violet-700 transition hover:bg-violet-50"
...
export default {
    ...
    computed: {
        /**
         * Mengembalikan nama tampilan yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
        ...
        /**
         * Mengembalikan produk jumlah yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
        ...
        /**
         * Mengembalikan primary produk yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi primary produk.
         */
        primaryProduct() {
        ...
        /**
         * Memproses produk gambar style untuk transaksi card.
         *
         * @returns {Object} Object produk gambar style yang telah disiapkan.
         */
        productImageStyle() {
            if (!this.primaryProduct?.img) return {};
        ...
        /**
         * Mengembalikan hidden produk jumlah yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi hidden produk jumlah.
         */
        hiddenProductsCount() {
        ...
        /**
         * Memproses key status untuk transaksi card.
         *
        ...
        /**
         * Mengembalikan status yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
        ...
        /**
         * Mengembalikan show tombol pembayaran yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
        ...
        /**
         * Mengembalikan show payment card yang dihitung dari state reaktif saat ini untuk transaksi card.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi show payment card.
         */
        showPaymentCard() {
        ...
        /**
         * Memproses logo pembayaran untuk transaksi card.
         *
        ...
        /**
         * Memproses label total untuk transaksi card.
         *
    ...
    methods: {
        /**
         * Memformat mata uang untuk ditampilkan untuk transaksi card.
         *
