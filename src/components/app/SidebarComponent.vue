<template>
    <ul
        ...
        @click.stop >
        <li v-if="this.$store.getters.user.account_type == 'buyer'" class="flex items-center gap-4">
            ...
            <router-link 
                ...
                :class="{'underline': (this.$route.path === '/buyer/beranda')}">
                Beranda
            </router-link>
        </li>
        <li v-if="this.$store.getters.user.account_type == 'seller'" class="flex items-center gap-4">
            ...
            <router-link 
                to="/seller/dashboard" 
                class="link-sidebar transition-all duration-300 hover:underline"
                :class="{'underline': (this.$route.path === '/seller/dashboard')}">
                Dashboard
            </router-link>
        </li>
        <li v-if="this.$store.getters.user.account_type == 'seller'" class="flex items-center gap-4">
            ...
            <router-link 
                to="/seller/product" 
                class="link-sidebar transition-all duration-300 hover:underline"
                :class="{'underline': (this.$route.path.startsWith('/seller/product'))}">
                Produk
            </router-link>
        </li>
        <li v-if="this.$store.getters.user.account_type == 'buyer'" class="flex items-center gap-4">
            ...
            <router-link 
                to="/buyer/belanja" 
                class="link-sidebar transition-all duration-300 hover:underline"
                :class="{'underline': (this.$route.path.startsWith('/buyer/belanja'))}">
                Belanja
            </router-link>
        </li>
        <li v-if="this.$store.getters.user.account_type == 'buyer'" class="flex items-center gap-4">
            ...
            <router-link 
                to="/buyer/keranjang" 
                class="link-sidebar transition-all duration-300 hover:underline"
                :class="{'underline': (this.$route.path.startsWith('/buyer/keranjang'))}">
                Keranjang
            </router-link>
        </li>
        <li v-if="this.$store.getters.user.account_type == 'buyer'" class="flex items-center gap-4">
            ...
            <router-link 
                ...
                class="link-sidebar transition-all duration-300 hover:underline"
                :class="{'underline': (this.$route.path.startsWith('/buyer/transaction'))}">
                Transaksi
            </router-link>
        </li>
        <li v-if="this.$store.getters.user.account_type == 'seller'" class="flex items-center gap-4">
            ...
            <router-link 
                ...
                class="link-sidebar transition-all duration-300 hover:underline"
                :class="{'underline': (this.$route.path.startsWith('/seller/transaction'))}">
                Transaksi
            </router-link>
        </li>
