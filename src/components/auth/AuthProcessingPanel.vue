...
export default {
    ...
    props: {
        ...
        errorSubtitle: {
            type: String,
            default: 'Sesi akun sudah aktif, tetapi data aplikasi belum berhasil disiapkan.',
        },
    ...
    computed: {
        /**
         * Mengembalikan resolved title yang dihitung dari state reaktif saat ini untuk auth processing panel.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi resolved title.
         */
        resolvedTitle() {
            return this.errorMessage ? this.errorTitle : this.title;
        },
        /**
         * Mengembalikan resolved subtitle yang dihitung dari state reaktif saat ini untuk auth processing panel.
         *
         * @returns {*} Nilai yang dihasilkan oleh operasi resolved subtitle.
         */
        resolvedSubtitle() {
