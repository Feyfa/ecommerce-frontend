...
export default {
    /**
     * Membuat state reaktif yang digunakan komponen untuk user setting.
     *
    ...
    /**
     * Menginisialisasi behavior komponen yang bergantung pada browser setelah mounted untuk user setting.
     *
    ...
    /**
     * Melepaskan resource komponen dan pekerjaan tertunda sebelum unmount untuk user setting.
     *
     * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
     */
    beforeUnmount() {
    ...
    methods: {
        /**
         * Memvalidasi phone untuk user setting.
         *
        ...
        /**
         * Mengambil user untuk user setting, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        getUser() {
        ...
        /**
         * Memperbarui input untuk user setting, dengan mendelegasikan pekerjaan backend atau shared state melalui Vuex store.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        updateInput() {
        ...
        /**
         * Memvalidasi dan menyinkronkan input nomor telepon pada pengaturan user.
         *
         * @returns {void} Function menerapkan efeknya melalui state komponen atau aplikasi.
         */
        watchInputPhone() {
